...
import ifpb.edu.recipes.data.model.AnalyzedInstruction
...
interface RecipeApi {
    ...
    @GET("recipes/{id}/analyzedInstructions?apiKey=4f285b25f9df4505a2e5b63dce3d8fab")
    suspend fun getInstructions(@Path("id") recipeId: Int): List<AnalyzedInstruction>
}